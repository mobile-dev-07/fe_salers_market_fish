  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => sl<ProductBloc>()..add(FetchProducts()), lazy: false,),
        BlocProvider<AddressBloc>(
          create: (_) => sl<AddressBloc>()..add(LoadAddresses()),
        ),
      ],
      child: MaterialApp(
        ...
        home: _token != null ? BlocProvider.value(
          value: sl<ProductBloc>()..add(FetchProducts()),
          child: HomeScreen(),
        ) : const SignInScreen(),
...
// import 'package:gudang_market_fish/screens/home/views/home_screen.dart';
// import 'package:gudang_market_fish/screens/onboarding/views/onboarding_screen.dart';
//
